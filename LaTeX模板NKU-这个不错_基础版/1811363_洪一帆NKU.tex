...
\begin{titlepage}
    ...
    \HRule \\[2.0cm]
    \centering
    \textsc{\LARGE \kaishu{\ \ \ \ 洪一帆 1811363}}\\[0.5cm]
    \textsc{\LARGE \kaishu{年级\ :\ 2018级}}\\[0.5cm]
...
\begin{figure}[H]
    \centering
    \includegraphics[\width=0.8\textwidth]{NKU.png}
    \caption{Caption}
    \label{fig:1}
\end{figure}
...
\begin{table}[!htbp]
  ...
  \midrule
  64/2& 0.0167& 0.01255& 0.04142& \tabincell{c}{Effective Physical\\Core Utilization\\(utilized cores out of 4)}\\
